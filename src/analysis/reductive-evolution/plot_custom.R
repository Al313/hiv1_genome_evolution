...
custom_plot_theme <- function(application = "publication", scale = 1) {
    ...
    theme(
        ...
        axis.text.x = element_text(family = "sans", size = size_set[[application]]["axis_text"], color = "#5e5e5e", angle = 90),
        axis.text.y = element_text(family = "sans", size = size_set[[application]]["axis_text"], color = "#5e5e5e"),
        strip.text.x = element_text(size = 50, angle=0),
        strip.text.y = element_text(size = 50, angle=270),
        legend.title = element_text(family = "Times", size = size_set[[application]]["legend_title"], color = "#373636"),
        legend.text = element_text(family = "sans", size = size_set[[application]]["legend_text"], color = "#5e5e5e")
    )
}
