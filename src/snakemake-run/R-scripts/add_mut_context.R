...
variants_ann <- read.table(file = "/home/amovas/data/genome-evo-proj/results/tables/2-pp/all_annotated_variants.tsv.gz", 
...
write.table(variants_ann, 
    file = gzfile("/home/amovas/data/genome-evo-proj/results/tables/2-pp/all_annotated_variants.tsv.gz"), sep = "\t", row.names = F, quote = F)
