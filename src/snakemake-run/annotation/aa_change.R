...
features_cds <- read.table(file = "/home/amovas/data/genome-evo-proj/results/tables/2-p/cds_feature_list.tsv", 
                            sep = "\t", header = T, stringsAsFactors = F)


# read in annotated variants in vcf format to extract the INFO filed

ann_var_vcf <- read.vcfR(file = "/home/amovas/data/genome-evo-proj/results/tables/2-p/all_variants.ann.vcf.gz")
...
ann_var_df <- read.table(file = "/home/amovas/data/genome-evo-proj/results/tables/2-p/all_variants.ann.vcf.gz", header = F,
