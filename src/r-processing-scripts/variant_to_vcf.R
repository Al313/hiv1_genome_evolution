  ...
  variants <- read.table(file = "/Users/alimos313/Documents/studies/phd/hpc-research/genome-evo-proj/results/tables/3-p/all_variants.csv.gz", sep = ",", stringsAsFactors = F, header = T)
  head(variants)
  ...
  write.table(variants, file = "/Users/alimos313/Documents/studies/phd/hpc-research/genome-evo-proj/results/tables/3-p/all_variants.tsv", sep = "\t", quote = F, row.names = F)
  
  vcf_variants <- read.table(file = "/Users/alimos313/Documents/studies/phd/hpc-research/genome-evo-proj/results/tables/3-p/all_variants.tsv", sep = "\t", stringsAsFactors=F, header = T)
  ...
  cat(vcf_header, file = '/Users/alimos313/Documents/studies/phd/hpc-research/genome-evo-proj/results/tables/3-p/all_variants.vcf', sep = '\n')
  
  write.table(vcf_variants, file = '/Users/alimos313/Documents/studies/phd/hpc-research/genome-evo-proj/results/tables/3-p/all_variants.vcf', sep = "\t", row.names = F, quote = F, append = T)  
